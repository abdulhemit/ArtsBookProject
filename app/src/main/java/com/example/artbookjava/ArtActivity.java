...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")){
            ...
            try {
                ...
                int imgeIndex = cursor.getColumnIndex("image");

                while (cursor.moveToNext()){
                    binding.nameText.setText(cursor.getString(nameIndex));
                    binding.nameAristText.setText(cursor.getString(painterIndex));
                    binding.yearText.setText(cursor.getString(yearIndex));

                    byte[] bytes = cursor.getBlob(imgeIndex);
    ...
    public void Save(View view){
        ...
        String painterName = binding.nameAristText.getText().toString();
    ...
    public void selectimage(View view){
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_DENIED){
            ...
            //gallery
            Intent intentTogalery = new Intent(Intent.ACTION_PICK , MediaStore.Images.Media.INTERNAL_CONTENT_URI);
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result){
                    ...
                    Toast.makeText(ArtActivity.this,"Permission nedded!",Toast.LENGTH_LONG).show();
                }
